...
public class home_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnLength, btnTemperature, btnWeight, btnTime, btnArea, btnVolume;
        ...
        btnTime.setOnClickListener(v -> openConverter("Time"));
        btnArea.setOnClickListener(v -> openConverter("Area"));
